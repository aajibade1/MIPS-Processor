...
add wave -noupdate -group Memory /system_tb/DUT/CPU/DP/mif/opcode
...
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/datomic
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/dhit
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/dmemaddr
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/dmemload
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/dmemREN
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/dmemstore
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/dmemWEN
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/flushed
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/halt
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/ihit
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/imemaddr
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/imemload
add wave -noupdate -expand -group DP /system_tb/DUT/CPU/dcif/imemREN
...
add wave -noupdate -group ICACHE /system_tb/DUT/CPU/iCM/cache_index
add wave -noupdate -group ICACHE /system_tb/DUT/CPU/iCM/cached_addr
add wave -noupdate -group ICACHE /system_tb/DUT/CPU/iCM/imiss
add wave -noupdate -group ICACHE /system_tb/DUT/CPU/iCM/incoming_tag
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/byteOffset
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/nextByteOffset
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/index
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/nextIndex
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/tag
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/nextTag
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/daddr
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/nextDaddr
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/dcache
add wave -noupdate -expand -group DCACHE -subitemconfig {{/system_tb/DUT/CPU/dCM/next_dcache[0].frame[0]} -expand} /system_tb/DUT/CPU/dCM/next_dcache
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/doperation
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/nextDoperation
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/frameSel
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/nextFrameSel
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/hitCounter
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/nextHitCounter
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/nextFlushed
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/state
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/nextState
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/store
add wave -noupdate -expand -group DCACHE /system_tb/DUT/CPU/dCM/nextStore
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {817275 ps} 0}
...
update
WaveRestoreZoom {4 ns} {1636838 ps}
